...
typedef struct HeadsetInterface {
  ...
  bool (*init)(float offset, float supersample, uint32_t msaa);
  void (*destroy)(void);
...
bool lovrHeadsetInit(HeadsetDriver* drivers, size_t count, float offset, float supersample, uint32_t msaa);
